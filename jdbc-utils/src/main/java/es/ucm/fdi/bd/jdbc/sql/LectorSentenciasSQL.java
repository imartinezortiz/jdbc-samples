...
/**
 * Permite leer las sentencias SQL de un archivo de text.
 * 
...
public class LectorSentenciasSQL {
	...
	/**
	 * Constructor del lector de sentencias SQL.
	 * 
	 * @param is {@link InputStream} utilizado para leer las sentencias. El {@link LectorSentenciasSQL} no
	 * se encarga de gestionar el cierre del {@link InputStream}.
	 */
	...
	/**
	 * Devuelve la siguiente sentencia SQL del {@link InputStream}. Las sentencias SQL
	 * pueden estar estructuradas en varias líneas ya que como caracter de
	 * separación entre sentencias SQL es el caracter &quot;;&quot;.
	 *  
	 * @return la sentencia SQL leída.
	 * 
	 * @throws IOException si existe algún problema durante la lectura.
	 */
